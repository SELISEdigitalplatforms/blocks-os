...
export const RemoveMembership = ({
  ...
  const onConfirm = async () => {
    try {
      ...
      ).filter((id) => id !== membership.organizationId);
      ...
      showSuccessToast({
        description: "Organization membership removed successfully",
      });
      onOpenChange(false);
      onSuccess?.();
    } catch (error) {
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            {organizationName}&quot;? This will revoke all roles associated with
            this organization.
          </DialogDescription>
        </DialogHeader>
        <DialogFooter>
