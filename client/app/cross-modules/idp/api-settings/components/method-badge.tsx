...
const METHOD_STYLES: Record<string, string> = {
  ...
  PATCH:
    "bg-purple-500/10 text-purple-600 ring-1 ring-purple-500/40 dark:text-purple-400 dark:ring-purple-400/30",
  DELETE:
    "bg-red-500/10 text-red-600 ring-1 ring-red-500/40 dark:text-red-400 dark:ring-red-400/30",
};
