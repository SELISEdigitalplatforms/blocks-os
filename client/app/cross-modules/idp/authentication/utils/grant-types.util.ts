...
export const canonicalizeGrantType = (value: string): string =>
  GRANT_TYPE_ALIASES[value] ?? value
...
export const isGrantTypeSelected = (selected: string[] | undefined, optionValue: string): boolean => {
