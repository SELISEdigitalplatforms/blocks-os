...
export const SignupSettingsTab = () => {
  ...
  const showLoader = configState.showLoader || rolesQuery.isPending || permissionsQuery.isPending;
  const showError = configState.showError || rolesQuery.isError || permissionsQuery.isError;
