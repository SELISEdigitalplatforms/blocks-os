...
export const UsersDateFilters = () => {
  ...
  const roleOrganizationIds = useMemo(() => {
    ...
    return selectedOrganizationIds.length > 0
      ? selectedOrganizationIds
      : organizations.map((organization) => organization.itemId);
  }, [organizations, selectedOrganizationIds, showOrganizationFilter]);
  ...
  return (
    <FilterToolbar<DateFilters>
      ...
      values={{
        organizationIds: showOrganizationFilter ? selectedOrganizationIds : [],
        roles: selectedRoles,
        joinedOn: isoToRange(
