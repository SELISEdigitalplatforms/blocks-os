...
import {
  BLOCKS_PRODUCTS,
  type LoginCarouselItem,
} from "@/constants/blocks-products";
    ...
    <div className="blocksLogin-page">
      ...
      <nav className="site-nav">
        <div className="nav-left">
          <img src="/blocks-logos/os_light_mode.svg" className="nav-logo-mark dark:hidden" alt="" />
          <img src="/blocks-logos/os_dark_mode.svg" className="nav-logo-mark hidden dark:block" alt="" />
        </div>
      ...
      <main className="main">
        ...
        <div className="col-right">
          <div className="sdk-header-row">
            ...
            <Badge variant="outline" className="sdk-count-badge">{carouselSource.length} services</Badge>
          </div>
                ...
                return (
                  <div className="sdk-card" key={cardKey}>
                    <div className="sdk-card-top">
                      ...
                      <Badge variant="outline" className="sdk-badge">{badge}</Badge>
                    </div>
