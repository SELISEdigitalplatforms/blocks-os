    ...
    <DropdownMenu>
      {collapsed ? (
        <SidebarCollapsedTooltip
          ...
          show={collapsed}
        >
          <DropdownMenuTrigger className="relative flex h-10 w-full items-center justify-center rounded-lg transition-colors hover:bg-accent hover:text-accent-foreground">
